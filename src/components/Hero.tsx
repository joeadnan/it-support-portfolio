...
//       <div className="relative mx-auto grid min-h-screen max-w-7xl items-center gap-12 px-6 py-28 lg:grid-cols-[1.1fr_1fr_0.9fr] lg:px-8">
//         <div>
...
//             alt={profile.name}
//             className="h-16 w-16 rounded-full border-2 border-sky-400/30 object-cover sm:h-20 sm:w-20 md:h-24 md:w-24 lg:h-28 lg:w-28 shadow-xl transition-all duration-300"
//           />
//         </div>
