...
export const certifications: Certification[] = [
  ...
  },
  {
    ...
    status: "Completed",
    category: "Cyber Security",
    imageUrl: "/certifications/CyberScurity Codepolitan.jpg",
    description:
      "Mempelajari dasar-dasar cyber security, termasuk pengenalan keamanan sistem, keamanan jaringan, ancaman siber, malware, phishing, password security, keamanan data, serta praktik dasar menjaga sistem dan informasi agar tetap aman.",
    skills: [
  ...
  },
  {
    ...
    description:
      "Mempelajari dasar-dasar MongoDB sebagai database NoSQL, termasuk konsep collection, document, field, CRUD data, query dasar, filtering data, serta penggunaan MongoDB untuk mendukung pengembangan aplikasi modern berbasis JavaScript.",
    skills: [
      "MongoDB Basics",
      "NoSQL Database",
      "Collection",
  ...
  },
  {
    ...
    description:
      "Mempelajari pengembangan aplikasi web secara fullstack menggunakan JavaScript, mulai dari pembuatan tampilan frontend, pengelolaan backend, REST API, database, autentikasi, hingga deployment aplikasi web. Pembelajaran ini berfokus pada praktik membangun aplikasi modern yang responsif, terstruktur, dan siap digunakan.",
    skills: [
      "JavaScript",
      "HTML",
      "CSS",
